...
func (n *nullCounter) RecordHits(count uint64) {

}

func (n *nullCounter) RecordMisses(count uint64) {

}

func (n *nullCounter) RecordLoadSuccess(loadTime time.Duration) {

}

func (n *nullCounter) RecordLoadError(loadTime time.Duration) {

}

func (n *nullCounter) RecordEviction() {

}

func (n *nullCounter) Snapshot(stats *Stats) {
